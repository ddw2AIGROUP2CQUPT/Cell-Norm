...
def main():
    ...
    parser.add_argument(
        "--image-folder",
        type=str,
        default="/home/ubuntu/san/TCT/DataSets/v4_1024/images/val",
        help="图片目录（建议 640×640；否则默认缩放到 640）",
    )
    parser.add_argument(
        "--xml-folder",
        type=str,
        default="/home/ubuntu/san/TCT/DataSets/v4_1024/labels/val",
        help="XML 目录",
    )
    parser.add_argument(
        "--output-image",
        type=str,
        default="/home/ubuntu/san/TCT/DataSets/v4_1024/1024_to_640_1xdata_5_20/val/images",
        help="输出图片目录",
    )
    parser.add_argument(
        "--output-xml",
        type=str,
        default="/home/ubuntu/san/TCT/DataSets/v4_1024/1024_to_640_1xdata_5_20/val/labels",
